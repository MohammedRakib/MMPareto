...
from models.models import URFunnyVTClassifier
...
def main():
    ...
    model = URFunnyVTClassifier(args)
    model.to(device)
    ...
    if args.train:
        ...
        for epoch in range(args.epochs):
            ...
            if acc > best_acc:
                ...
                print("Loss: {:.4f}, Acc: {:.4f},  Acc_v: {:.4f}, Acc_t: {:.4f}".format(
                    batch_loss, acc, acc_v, acc_t))
            else:
                print("Loss: {:.4f}, Acc: {:.4f}, Acc_v: {:.4f}, Acc_t: {:.4f},Best Acc: {:.4f}".format(
                    batch_loss, acc, acc_v, acc_t, best_acc))
